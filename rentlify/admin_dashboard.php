...
$totalTenants = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tableuser WHERE role = 'tenant'"));
?>

<!-- Rest of the existing dashboard HTML remains the same -->
...
<!-- Additional CSS to enhance the sidebar -->
<style>
    .sidebar-divider {
...
document.addEventListener('DOMContentLoaded', function() {
    // Optional: Add active state tracking
