...
public class Landlord_Fragment_Profile extends Fragment {
    private static final int PICK_IMAGE_REQUEST = 101;
    private static final int EDIT_PROFILE_REQUEST = 102;
//   private static final String URL_USER_DETAILS = "http://f29-preview.awardspace.net/rentlify.kesug.com/get_user_details.php";
    private static final String URL_USER_DETAILS = "http://10.0.2.2/rentlify/get_user_details.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v.findViewById(R.id.edit_profile_option).setOnClickListener(b -> {
            if (!isAdded()) return;
            Intent intent = new Intent(getActivity(), LandlordEditProfileActivity.class);
